            ...
            child: Column(
              ...
              Row(
                ...
                children: List.generate(3, (index) => homeButton(
                  ...
                  title: index==0 ? 'Top Categories': index==1 ?'Brands' : 'Top Sellers'
                )),
              ),
              ...
              Align(
                ...
                child: 'Feature Categories'.text.color(darkFontGrey).size(18).fontFamily(semibold).make()),
                ...
                Container(
                  ...
                  child: Column(
                    children:[
                    "Featured Products".text.fontFamily(bold).size(18).white.make(),
                    10.heightBox,
                    SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                      child: Row(
                ...
                GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 8,crossAxisSpacing: 8,mainAxisExtent: 300), itemBuilder: (context,index){
                    return Column(
                      ...
                      children:[
                      Image.asset(imgP5,height:200, width: 200,fit: BoxFit.fill),
                       10.heightBox,
                            "Laptop 4GB".text.color(darkFontGrey).fontFamily(semibold).make(),
                            10.heightBox,
                            "\$600".text.color(redColor).size(16).fontFamily(bold).make()
