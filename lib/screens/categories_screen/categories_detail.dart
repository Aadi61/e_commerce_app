        ...
        body: Column(
          children: [
            SingleChildScrollView(
              ...
              child: Row(
                children: List.generate(6, (index) => "Clothing".text.size(12).fontFamily(semibold).color(darkFontGrey).makeCentered().box.white.rounded.margin(EdgeInsets.symmetric(horizontal: 4)).size(120, 60).make()),
              ),
            ),
            20.heightBox,
            Expanded(child: GridView.builder(
              ...
              return Column(
                      ...
                      Image.asset(imgP5,height:150, width: 200,fit: BoxFit.fill),
                       10.heightBox,
                            "Laptop 4GB".text.color(darkFontGrey).fontFamily(semibold).make(),
                            10.heightBox,
                            "\$600".text.color(redColor).size(16).fontFamily(bold).make()
                          
                      ]
                    ).box.white.margin(EdgeInsets.symmetric(horizontal: 4)).padding(EdgeInsets.all(12)).outerShadowSm.roundedSM.make().onTap(() {
                      Get.to(ItemDetails());
                    });
